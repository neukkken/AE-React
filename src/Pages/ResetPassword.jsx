...
const API_URL_RESET_PASSWORD = 'https://projetback-r7o8.onrender.com/auth/reset-password';
...
export default function ResetPassword() {
  ...
  if (!tokenValid) {
    return <div>Token inválido o ausente. Redirigiendo a la página de inicio de sesión...</div>;
  }
    ...
    <div className="reset-password-container">
      <CForm onSubmit={handleSubmit} className="reset-password-form">
        ...
        {isLoading ? (
          ...
          <CButton color="primary" type="submit" className='mt-3'>Restablecer Contraseña</CButton>
        )}
      </CForm>
    </div>
  );
